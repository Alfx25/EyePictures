...
setInterval(function(){
    ...
    if(document.elementFromPoint(prediction.x, prediction.y).parentElement.classList.contains("hover") || document.elementFromPoint(prediction.x, prediction.y).classList.contains("hover")){
